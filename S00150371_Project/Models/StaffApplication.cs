...
namespace S00150371_Project.Models
{
    public class StaffApplication
    {
        ...
        [Required]
        [Display(Name = " Level")]
        [RegularExpression(@"\d\d", ErrorMessage = "The level must be a number")]
        ...
        [RegularExpression(@"\d\d", ErrorMessage = "The entry must be a number")]
